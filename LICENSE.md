## TSN "Ogata" © (2026) - Ascellayn, The Sirio Network | `TSN License 2.2 - Base`

# __The Sirio Network License - 2.2__
*https://sirio-network.com/license/2.2 | Published 26/04/2026 at 16:04:55 // UTC+1 Europe/Paris*  
...
#### PREAMBLE
The Sirio Network is **not a law firm nor does it provide legal services/advice**. The Licenses provided are provided ***"as-is"***, thus **no warranty are provided** nor should be requested.  
...
There may come a time when You may use the Work as if you were the Author, such as in cases such as ***"`forking`"*** (modifying and redistributing the original Work), the users of Your Fork are considered ***"`Third-Parties`"***.  
...
- The Sirio Network is **not responsible for any legal help**, we are simply providing a guideline that, in an utopia should be fully respected by all parties involved.

- The use of this Work in a **personal environment** (not available publicly in any capacity, thus not available to any third-party) is entirely authorized and thus lifts any restrictions.
...
- The use of this Work to train "AI Models" is **strictly forbidden**.
- This work **cannot contain any form of AI Generated Content** from Models that have been trained ***on data you do not own or have the authorization to use***. Failure to comply voids the validity of this license.
...
Redistribution is defined as **re-uploading in any capacity, shape or form** whenever modified or not, this piece of Work anywhere publicly on the internet. Attribution is required unless these specific restrictions have been lifted.  
...
- Redistribution of the *latest version* of this Work **must be linked to the original source** by providing the licensing text and **must not re-upload** any of the files concerning this Work.
	- Previous versions of this Work may be freely redistributed, and in turn authorized to fully re-upload, in a non-commercial environment.
...
Any redistribution of this Work, *whenever it is in modified or unmodified form*, must be **distributed with the exact same licensing terms** and cannot be modified.  
...
This work allows you to "derivate" it thanks to the interfaces (i.e.: Modular System, APIs) it provides, you may copy/modify parts of this Work within reason if the provided interfaces aren't enough to be able to derivate this Work in a way you'd like.  
...
The Timed special-modifier permits an Author to attempt to assure the protection of their Work while they're actively working on it, but still gives You a chance to Work on the project and attempt to improve it as older versions of the Work's restrictions expires.  
